v1.4.2 変更点（v1.4.1 から）
1. タスクトレイアイコンの視認性を改善

US / JA 状態を示すタスクトレイアイコンのデザインを見直し、
状態が一目で判別しやすくなるよう改善しました。

2. Alt-IME 操作の割り当てを変更

US モード時の Alt-IME 操作について、左右 Alt の役割を以下のように変更しました。

左 Alt 単押し：IME OFF（英数）

右 Alt 単押し：IME ON（日本語）
